    ...
    return(
        <div>
            <div className="md:ml-36 md:mt-36">
              ...
              <Image src={'/images/mlo.png'} alt={'pics'} width={1920} height={160} className="md:absolute top-[76vw] left-0" />
           ...
           <Image src={'/images/Video Button.png'} alt={'pics'} width={100} height={160} className="md:ml-60 md:-mt-9 " />
             ...
             <p className="md:-ml-72 md:w-[35vw] md:mt-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero consectetur facilis, debitis aperiam, blanditiis dolorum fuga, nobis eius labore illum nisi .</p>
                </div>
        </div>
    )
}